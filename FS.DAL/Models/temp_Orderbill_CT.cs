...
{
  public class temp_Orderbill_CT
  {
    ...
    [ColumnDescription("")]
    public string _start_lsn { get; set; }

    [ColumnDescription("")]
    public string _end_lsn { get; set; }

    [ColumnDescription("")]
    public string _seqval { get; set; }

    [ColumnDescription("")]
    public int _operation { get; set; }

    [ColumnDescription("")]
    public string _update_mask { get; set; }
